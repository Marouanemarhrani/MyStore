...
const AdminOrders = () => {
    ...
    const getOrders = async() => {
        try {
            ...
            console.log(error);
            toast.error("There was an error in getting all orders");
        }
    };
    ...
    const handleChange = async (orderId, value) => {
        try {
            ...
            getOrders();
            toast.success("sencond succ")
        } catch (error) {
            console.log(error);
            toast.error("Ther was an error in updating the status of the product")
        }
    };
    return (
                            ...
                            o?.products?.map((p, i) => (
                                <div className="row mb-2 p-3 card flex-row" key={p._id}>
                                    <div className="col-md-4">
                                        <img 
                                            src={`${process.env.REACT_APP_API}/api/v1/product/photoURL/${p?._id}`} 
